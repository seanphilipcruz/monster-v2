<template>
    <div class="footer bg-medium-gray-container justify-content-center">
        <client-only>
            <div class="mx-2 my-3">
                <div class="row">
                    <div class="col">
                        <div class="text-center text-light">
                            <a id="scroll_top" href="#" class="scroll-top">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="text-center">
                                <a href="https://www.facebook.com/MonsterBT995" target="_blank" class="btn btn-social-icon btn-facebook text-light mx-1">
                                    <font-awesome-icon :icon="['fab', 'fa-facebook-f']" />
                                </a>
                                <a href="https://www.twitter.com/monsterbt995" target="_blank" class="btn btn-social-icon btn-twitter text-light mx-1">
                ...
                <div class="row text-light barlow-footer">
                    <div class="col-12">
                    ...
                    <div class="col-12 text-center">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-10">
                                <div class="small">
                                    <nuxt-link :to="{ name: 'PrivacyPolicy' }">Privacy Policy</nuxt-link> | <nuxt-link :to="{ name: 'About' }">About</nuxt-link> | <nuxt-link :to="{ name: 'ContactUs' }">Contact</nuxt-link>
                                </div>
                            </div>
                        </div>
                    </div>

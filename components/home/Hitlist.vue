                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-10">
                                <div class="mx-2">
                                    ...
                                    <p class="barlow text-light">Catch the countdown every Friday, 7 to 8PM with Hazel Hottie</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-2">
                    <div class="col-12 col-sm-12">
                        ...
                        <div class="d-none d-md-none d-lg-none d-xl-none d-xxl-none">
                            ...
                            <div class="row">
                                <div class="col">
                                    <router-link :to="{ name: 'CountdownTop7' }" class="btn btn-info btn-monster-blue btn-rounded d-grid">LISTEN: TOP 20</router-link>
                                </div>
                            </div>
                        </div>
                    </div>

                        ...
                        <div class="d-block d-sm-block d-md-none d-lg-none d-xl-none d-xxl-none">
                            <div class="row g-0">
                                <div class="col-2 text-center">
                                    <div class="my-1"></div>
                                    <img src="~/images/home/latest-news.png" alt="latest-news" class="img-fluid img-icon">
                                </div>
                                <div class="col-10">
                                ...
                                <div class="col col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3 mt-4" v-if="article">
                                    <div class="card bg-light-gray text-light">
                                        <div class="image-container">
                                            <img :src="article.image" alt="latest-article" class="card-img-top rounded-start">
                                            <div class="overlay">
                                                <img src="~/images/home/articles.png" alt="latest-image" class="icon">
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <p class="mb-0 text-center card-title">News, Blogs, and Articles</p>
                                ...
                                <div class="col col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3 mt-4">
                                    <div class="card bg-light-gray text-light">
                                        <div class="image-container">
                                            ...
                                            <div class="overlay">
                                                <img src="~/images/home/youtube.png" alt="latest-youtube" class="icon">
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <p class="mb-0 text-center card-title">YouTube Channel</p>

    ...
    <div class="socials-container">
        <div class="facebook active text-center">
            <iframe v-if="type === 'home'"
                    src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fbt1059%2F&tabs=timeline&width=400&height=541&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=250218719159269"
                    width="400"
                    height="541"
        ...
        <div class="twitter text-center" hidden>
            <a
                ...
                data-dnt="true"
                data-theme="dark"
                href="https://twitter.com/bt1059?ref_src=twsrc%5Etfw">
                Tweets by bt1059
            </a>
        </div>
        <div class="instagram text-center" hidden>
            <iframe
                src="https://snapwidget.com/embed/794420"

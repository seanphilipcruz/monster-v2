...
export default {
    ...
    head() {
        return {
            title: 'Monster Shows',
            meta: [
                { hid: 'description', name: 'description', content: "Davao’s hottest radio programs!" },
                { 'property': 'og:url', content: this.siteUrl + this.routePath },
                { 'property': 'og:title', content: `Monster Shows | ${this.stationName}` },
                { 'property': 'og:description', content: "Davao's hottest radio programs!" },
                ...
                { 'property': 'twitter:description', content: "Davao's hottest radio programs!" },

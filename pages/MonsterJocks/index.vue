...
export default {
    ...
    head() {
        return {
            title: 'Monster Jocks',
            meta: [
                { hid: 'description', name: 'description', content: `Meet the ${this.stationName} Jocks who fire up your day with good music and fun discussions!` },
                { 'property': 'og:url', content: this.siteUrl + this.routePath },
                { 'property': 'og:title', content: `Monster Jocks | ${this.stationName}` },
                { 'property': 'og:description', content: `Meet the ${this.stationName} Jocks who fire up your day with good music and fun discussions!` },
                ...
                { 'property': 'twitter:description', content: `Meet the ${this.stationName} Jocks who fire up your day with good music and fun discussions!` },

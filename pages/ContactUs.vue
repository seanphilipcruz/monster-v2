            ...
            <transition name="fade">
                <div class="my-5" v-if="!isLoading">
                    <div class="row">
                            ...
                            <div class="d-block d-sm-block d-md-block d-lg-none d-xl-none d-xxl-none">
                                <div class="row g-0 align-content-center">
                                    <div class="col-2 text-center">
                                        <div class="my-1"></div>
                                        <img src="~/images/contact/icon.png" alt="contact" class="img-fluid img-icon">
                                    </div>
                                    <div class="col-10 align-self-center">
                                        <p class="fs-4 header mb-0">CONTACT US</p>
                                        <p class="barlow text-light">We would like to hear from you!</p>
                                    </div>
                                </div>
                                <div class="my-4"></div>
                                <div class="row">
                                        ...
                                        <div class="card bg-medium-gray text-light">
                                            ...
                                            <div class="card-body">
                                                <div class="row justify-content-center">
                                                    <div class="col col-sm-5 col-md-6 d-grid">
                                    ...
                                    <div class="card bg-light-gray text-light">
                                        <div class="row g-0">
                                            <div class="col-12 col-md-3 align-self-center">
                                                <div class="card-img">
                                                    <div class="my-4 text-center">HOW TO CLAIM YOUR PRIZE?</div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-4">
                            <feedback-form :recaptcha-key="recaptchaKey" />
                        </div>
                    </div>
                </div>
            </transition>
...
export default {
    ...
    head() {
        return {
            title: 'Contact Us',
            meta: [
                { hid: 'description', name: 'description', content: 'Get in touch with Monster RX93.1 via email, phone, or message.' },
                { 'property': 'og:url', content: "https://rx931.com" + this.routePath },
                { 'property': 'og:title', content: 'Contact Us | Monster RX93.1' },
                { 'property': 'og:description', content: 'Get in touch with Monster RX93.1 via email, phone, or message.' },
                ...
                { 'property': 'twitter:title', content: 'Contact Us | Monster RX93.1' },
                { 'property': 'twitter:description', content: 'Get in touch with Monster RX93.1 via email, phone, or message.' },
